...
async def contacts(update: Update, lang):
    if lang == "uz":
        text = (
            "📞 FUNLANDIA ALOQA\n\n"
            "📞 Kontakt: +998 93 381 00 55\n"
            "☎️ Call-markaz: +998 555 127 337\n\n"
        ...
        text = (
            "📞 КОНТАКТЫ FUNLANDIA\n\n"
            "📞 Контакт: +998 93 381 00 55\n"
            "☎️ Колл-центр: +998 555 127 337\n\n"
            "📱 Telegram: @Funlandia_Tashkent\n"
            "📸 Instagram: @funlandiauz"
        )
    await update.message.reply_text(text, reply_markup=menu(lang))
...
async def handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "Контакт" in text or "Kontakt" in text or "Администратор" in text or "Administrator" in text:
